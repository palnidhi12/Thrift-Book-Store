...
$query_user_details = "SELECT * FROM users WHERE user_id = $user_id";
$result_user_details = mysqli_query($connection, $query_user_details);
...
<body>
  ...
  <div class="backgroundh">
    <h1>Welcome to Thrift Book Store</h1>
