...
<head>
    ...
    <title>Non-Fictional Category</title>
...
<body>
    <div class="content">
        ...
        <nav class="nav-item">
            ...
            <?php endif; ?>
            <h1>List of Non-Fictional Books</h1>
        </nav>

        <section class="product-container">

            <?php
            if ($result_non_fictional && mysqli_num_rows($result_non_fictional) > 0) {
                while ($row = mysqli_fetch_assoc($result_non_fictional)) { ?>
                ...
                echo "<p>No non-fictional books found.</p>";
            }
            ?>
        </section>
